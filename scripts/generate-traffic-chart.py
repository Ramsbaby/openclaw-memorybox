#!/usr/bin/env python3
"""Generate GitHub traffic chart for openclaw-memorybox"""
...
def generate_chart(views_data, clones_data, output):
    ...
    ax.set_title('openclaw-memorybox Traffic (Last 14 Days)', fontsize=14, fontweight='bold')
...
if __name__ == "__main__":
    ...
    repo = "Ramsbaby/openclaw-memorybox"
